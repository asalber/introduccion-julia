...
## Paquetes para la representación gráfica

Existen múltiples paquetes para la representación gráfica en Julia. Los más usados son:

- [Plots.js](https://docs.juliaplots.org/). Es el paquete más usado y con más posibilidades gráficas. Sirve de interfaz para otras librerías gráficas como [Matplotlib](https://matplotlib.org/) o [Plot.ly](https://plotly.com/). Es bastante sencillo de utilizar. Su principal desventaja es que es bastante lento.
- [GadFly.js](http://gadflyjl.org/). Es un paquete que genera gráficos interactivos por medio de librerías de Javascript basadas en la [gramática de gráficos](https://www.cs.uic.edu/~wilkinson/TheGrammarOfGraphics/GOG.html) (usada también por el paquete ggplot2 de R) similares a Plot.ly. Es mucho más rápido que Plots.js pero es menos completo que este.
- [VegaLite.js](https://www.queryverse.org/VegaLite.jl). Es un paquete que genera gráficos estáticos por medio de las librerías de Javascript de la gramática de gráficos [Vega](https://vega.github.io/). Dispone de muchas más opciones de personalización de gráficos que GadFly.jl.


## Gráfica de una función con Plot.jl
...
## Gráfica interactiva de una función con Plot.jl via Plot.ly
...
### Gráficas de varias funciones con Plot.jl
