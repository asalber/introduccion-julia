...
- `v[i:j]`: Devuelve un vector con los elementos desde el índice `i` al `j`.
- `v[u]`: Devuelve un vector con los elementos correspondientes a los índices del vector `u`.
...
- `minimum(v)`: Devuelve el menor de los elementos del vector `v`.
- `maximum(v)`: Devuelve el mayor de los elementos del vector `v`.
