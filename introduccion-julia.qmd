...
[Julia](https://julialang.org/) es otro lenguaje de programación más, orientado al cálculo científicio y el análisis de datos, similar a Python, R o Matlab.

::: {.fragment .r-stack}
_¿De veras necesitamos aprender otro lenguaje más?_
:::

## ¿Qué pretende ser Julia? {.smaller}
...
- Lenguaje de alto nivel con una sintaxis fácil de aprender (similar a Python, R o Matlab) que permite escribir símbolos matemáticos en las expresiones (UTF-8).
...
- Muy rápido (equiparable a C en muchas tareas.)

---

### Comparativa de rapidez de Julia con otros lenguajes

![](./img/benchmarks.svg){fig-align="center"}
...
- Evita el problema de la doble reescritura de código (prototipo + producción).
